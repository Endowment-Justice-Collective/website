...
export function SiteHeader() {
  return <header className="site-header">
    <Link className="brand" href="/" aria-label="Endowment Justice Collective home"><span className="brand-logo" aria-hidden="true" /></Link>
...
export function SiteFooter() {
  return <footer className="site-footer">
    <div className="footer-brand"><span className="footer-brand-logo" role="img" aria-label="Endowment Justice Collective at Yale" /></div>
