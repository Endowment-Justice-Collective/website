...
export function SiteHeader() {
  return <header className="site-header">
    <Link className="brand" href="/" aria-label="Endowment Justice Collective home"><span><b>Endowment Justice</b><b>Collective at Yale</b></span></Link>
...
export function SiteFooter() {
  return <footer className="site-footer">
    <div className="footer-brand"><p>Endowment Justice<br />Collective at Yale</p></div>
